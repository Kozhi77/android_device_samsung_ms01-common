...
BOARD_KERNEL_CMDLINE := console=null androidboot.hardware=qcom androidboot.selinux=permissive user_debug=23 msm_rtb.filter=0x37 zcache.enabled=1 zcache.compressor=lz4 maxcpus=1
